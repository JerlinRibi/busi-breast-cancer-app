...
import os
from dotenv import load_dotenv  # ✅ For local fallback
...
# ---------------- LOAD CREDENTIALS ----------------
# Prefer Streamlit secrets (for deployment), fallback to .env/local defaults
try:
...
.sidebar .sidebar-content { background-color: #e6f2f8; }
</style>
...
def login():
    ...
    with col2:
        ...
        st.write("DEBUG USER:", ADMIN_USER)
