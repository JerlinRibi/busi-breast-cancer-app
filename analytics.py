...
def analytics_dashboard():
    ...
    with c2:
        ...
        counts.plot(kind="bar", ax=ax2, color=["#4CAF50", "#FF5252", "#2196F3"])
        ax2.set_xlabel("Class")
        ax2.set_ylabel("Count")
        ax2.set_title("Prediction Count by Class")
        st.pyplot(fig2)
    ...
    ax3.plot(trend.index, trend.values, color="blue", linewidth=2)
    ax3.scatter(trend.index, trend.values, color=colors, s=70)
